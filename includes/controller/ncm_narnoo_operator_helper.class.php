...
/*
* This is a helper class. Narnoo Operator API endpoints are there
*/
...
class NCM_Narnoo_Helper {
    ...
    public function init_api() {
        ...
        **/
        ...
        if( $narnoo_mode ) {
            ...
            $this->api_url = 'https://apis-test.narnoo.com/api/v1/'; //'https://test-apis.narnoo.com/​api/v1/';
    ...
    public function ncm_exec_curl() {
        ...
        curl_setopt($s, CURLOPT_HTTPHEADER, $this->authen);  //$this->authen
