...
class RapidAPI
{
    ...
    private function PostToRapidAPI($path, $request, $isPost = true)
    {
        ...
        if (curl_errno($ch) != CURLE_OK) {
            ...
            $newobj->Errors = "Connection Error: " . curl_error($ch) . " URL: $url";
            return $newobj;
            ...
            if ($info['http_code'] == 401 || $info['http_code'] == 404 || $info['http_code'] == 403) {
                ...
                $newobj = new \stdClass();//create a new
                $newobj->Errors = "Please check the API Key and Password $__is_in_sandbox";
                return $newobj;
            ...
            if ($decode === null) {
                ...
                $newobj = new \stdClass();//create a new
                $newobj->Errors = "Error decoding response from eWAY";
                return $newobj;
